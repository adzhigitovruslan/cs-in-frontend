...
Числа в JS используют по умолчанию формат Double (64 бита), но после применения побитовых операторов усекаются до 32 бит в форматах Int32 или Uint32.
...
SMI позволяет более эффективно представлять в памяти целые числа не превышающие 31 бит.
